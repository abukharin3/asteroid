...
if args.revised:
    ...
    dataset = "data/{}_train_gem_ccsd_{}.npz".format(args.molecule, args.n_pts)
    val_dataset = "data/{}_val_gem_ccsd_{}.npz".format(args.molecule, args.n_pts)
    test_dataset = "data/{}_test_gem_ccsd_{}.npz".format(args.molecule, args.n_pts)
    if not os.path.exists(dataset):
        process.process_ccsd(args.molecule, args.n_pts)
elif args.classic:
...
for step in range(step_init + 1, num_steps + 1):
    ...
    trainer.train_on_batch(train["dataset_iter"], train["metrics"], args)
