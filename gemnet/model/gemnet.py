...
class GemNet(torch.nn.Module):
    ...
    def forward(self, inputs, get_emb=False, adv=False):
        ...
        if not self.direct_forces and not adv:
    ...
    #         #bad_keys = {"out_blocks.0.scale_rbf.scale_factor", "out_blocks.0.seq_forces.0.weight", "out_blocks.0.seq_forces.0.linear.weight", "out_blocks.0.seq_forces.1.dense_mlp.0.weight", "out_blocks.0.seq_forces.1.dense_mlp.0.linear.weight", "out_blocks.0.seq_forces.1.dense_mlp.1.weight", "out_blocks.0.seq_forces.1.dense_mlp.1.linear.weight", "out_blocks.0.seq_forces.2.dense_mlp.0.weight", "out_blocks.0.seq_forces.2.dense_mlp.0.linear.weight", "out_blocks.0.seq_forces.2.dense_mlp.1.weight", "out_blocks.0.seq_forces.2.dense_mlp.1.linear.weight", "out_blocks.0.out_forces.weight", "out_blocks.0.out_forces.linear.weight", "out_blocks.1.scale_rbf.scale_factor", "out_blocks.1.seq_forces.0.weight", "out_blocks.1.seq_forces.0.linear.weight", "out_blocks.1.seq_forces.1.dense_mlp.0.weight", "out_blocks.1.seq_forces.1.dense_mlp.0.linear.weight", "out_blocks.1.seq_forces.1.dense_mlp.1.weight", "out_blocks.1.seq_forces.1.dense_mlp.1.linear.weight", "out_blocks.1.seq_forces.2.dense_mlp.0.weight", "out_blocks.1.seq_forces.2.dense_mlp.0.linear.weight", "out_blocks.1.seq_forces.2.dense_mlp.1.weight", "out_blocks.1.seq_forces.2.dense_mlp.1.linear.weight", "out_blocks.1.out_forces.weight", "out_blocks.1.out_forces.linear.weight", "out_blocks.2.scale_rbf.scale_factor", "out_blocks.2.seq_forces.0.weight", "out_blocks.2.seq_forces.0.linear.weight", "out_blocks.2.seq_forces.1.dense_mlp.0.weight", "out_blocks.2.seq_forces.1.dense_mlp.0.linear.weight", "out_blocks.2.seq_forces.1.dense_mlp.1.weight", "out_blocks.2.seq_forces.1.dense_mlp.1.linear.weight", "out_blocks.2.seq_forces.2.dense_mlp.0.weight", "out_blocks.2.seq_forces.2.dense_mlp.0.linear.weight", "out_blocks.2.seq_forces.2.dense_mlp.1.weight", "out_blocks.2.seq_forces.2.dense_mlp.1.linear.weight", "out_blocks.2.out_forces.weight", "out_blocks.2.out_forces.linear.weight", "out_blocks.3.scale_rbf.scale_factor", "out_blocks.3.seq_forces.0.weight", "out_blocks.3.seq_forces.0.linear.weight", "out_blocks.3.seq_forces.1.dense_mlp.0.weight", "out_blocks.3.seq_forces.1.dense_mlp.0.linear.weight", "out_blocks.3.seq_forces.1.dense_mlp.1.weight", "out_blocks.3.seq_forces.1.dense_mlp.1.linear.weight", "out_blocks.3.seq_forces.2.dense_mlp.0.weight", "out_blocks.3.seq_forces.2.dense_mlp.0.linear.weight", "out_blocks.3.seq_forces.2.dense_mlp.1.weight", "out_blocks.3.seq_forces.2.dense_mlp.1.linear.weight", "out_blocks.3.out_forces.weight", "out_blocks.3.out_forces.linear.weight", "out_blocks.4.scale_rbf.scale_factor", "out_blocks.4.seq_forces.0.weight", "out_blocks.4.seq_forces.0.linear.weight", "out_blocks.4.seq_forces.1.dense_mlp.0.weight", "out_blocks.4.seq_forces.1.dense_mlp.0.linear.weight", "out_blocks.4.seq_forces.1.dense_mlp.1.weight", "out_blocks.4.seq_forces.1.dense_mlp.1.linear.weight", "out_blocks.4.seq_forces.2.dense_mlp.0.weight", "out_blocks.4.seq_forces.2.dense_mlp.0.linear.weight", "out_blocks.4.seq_forces.2.dense_mlp.1.weight", "out_blocks.4.seq_forces.2.dense_mlp.1.linear.weight", "out_blocks.4.out_forces.weight", "out_blocks.4.out_forces.linear.weight"}
    #         state_dict = {}
    #         for k, v in checkpoint.items():#torch.load(path).items():
    #             state_dict[k] = v
